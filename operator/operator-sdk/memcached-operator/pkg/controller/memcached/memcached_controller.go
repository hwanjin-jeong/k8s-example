...
import (
	...
	cachev1alpha1 "github.com/hwanjin-jeong/k8s-example/operator/operator-sdk/memcached-operator/pkg/apis/cache/v1alpha1"
...
func (r *ReconcileMemcached) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// 3. Update the Memcached CR status using the status writer with the names of the memcached pods
	...
	if err != nil && errors.IsNotFound(err) {
		...
		reqLogger.Info("Creating a new Deployment", "Deployment.Namespace", dep.Namespace, "memcached.Name", dep.Name)
